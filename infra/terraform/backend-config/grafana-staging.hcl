# Purpose: Backend configuration for grafana infrastructure workspace in staging environment
...
# Environment: Staging environment grafana workspace

bucket               = "durable-code-terraform-state"
key                  = "grafana/staging/terraform.tfstate"
region               = "us-west-2"
encrypt              = true
